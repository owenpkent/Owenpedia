...
## Evrysdi Administration

1. Measure **6.6 mL** using the orange syringe
2. Attach large syringe to [feeding tube](./feeding.md)
3. Push medication through
4. Follow with a tall beaker of water

---

## Storage

- **Evrysdi** must be **refrigerated**

---

## Ordering

| Medication | Supplier | Phone |
|------------|----------|-------|
| Evrysdi | Accredo Pharmacy | (855) 525-7995 |
| Others | Local pharmacy | — |

---

## Travel Medications

See [Packing Checklist](../travel/packing-checklist.md) for travel medication list:
- Evrysdi (must be refrigerated)
- Allergy pills
- Glyco
- Clonazepam
